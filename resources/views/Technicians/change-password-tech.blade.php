    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/change-password-tech" class="nav-link active">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Change Password
  ...
  <div class="content-wrapper">
    <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
        <div class="container max-w-screen-lg mx-auto">
          <div>
            <h2 class="font-semibold text-xl text-gray-600">Change Technician Password</h2>
            ...
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                <div class="text-gray-600">
                  ...
                  <img src="{{asset('images/change-password.jpg')}}" alt="sideimage" style="border-radius: 20px">
                </div>
