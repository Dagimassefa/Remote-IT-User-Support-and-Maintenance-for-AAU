        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/submit-support-request" class="nav-link ">
  ...
  <div class="content-wrapper">
    ...
    <body class=" overflow flex items-center justify-center" style="background: #edf2f7;">
      ...
      <div class="container max-w-screen-lg mx-auto">
        <div>
          <h2 class="font-semibold text-xl text-gray-600">Send Feedback Form</h2>
          <p class="text-gray-500 mb-6">Tell Us What You Feel About This System.</p>
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                  ...
                  <div class="md:col-span-5 text-right">
                    <div class="inline-flex items-end">
                      <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Send Feedback</button>
                    </div>
                  </div>
