    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/change-password-user" class="nav-link active">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Change Password
  ...
  <div class="content-wrapper">
    ...
    <body class=" overflow flex items-center justify-center" style="background: #edf2f7;">
      ...
      <div class="container max-w-screen-lg mx-auto">
        <div>
          <h2 class="font-semibold text-xl text-gray-600">Change User Password</h2>
          <p class="text-gray-500 mb-6">Change Password Form</p>
